    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
        <div class="p-6 sm:p-8">
            ...
            <div class="flex justify-between items-center mb-8 pb-4 border-b border-gray-100">
                <h2 class="text-2xl font-bold text-gray-800">Edit Peserta Magang</h2>
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        ...
                        <div class="w-full">
                            <label for="divisi" class="block mb-2 text-sm font-semibold text-gray-700">Divisi /
                                Penempatan</label>
                            <input type="text" name="divisi" id="divisi" value="{{ old('divisi', $intern->divisi) }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="asal" id="asal" value="{{ old('asal', $intern->asal) }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition"
                        ...
                        <div class="w-full">
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai"
                                value="{{ old('tanggal_mulai', $intern->tanggal_mulai) }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition"
                                required>
                            @error('tanggal_mulai')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="w-full">
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                value="{{ old('tanggal_selesai', $intern->tanggal_selesai) }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition"
                                required>
